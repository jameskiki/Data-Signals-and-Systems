...
def keep_dataframe_index_ranges(
    ...
    """Return a copy containing only rows inside the requested half-open ranges [start, end)."""
    ...
    if kept_frame.empty:
        raise ValueError("Keeping these row ranges would leave an empty dataframe")
    return kept_frame
